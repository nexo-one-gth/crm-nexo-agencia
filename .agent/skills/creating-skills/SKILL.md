...
description: Crea y estructura nuevas skills de manera estandarizada y predecible. Úsalo como referencia cada vez que el usuario te pida crear una nueva skill, habilidad, herramienta o comando complejo para el entorno de agentes Antigravity.
---
